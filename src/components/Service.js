  ...
  const cardsData = [
    {
      ...
      text: `Buddyfin AI is designed to help users discover top-performing stocks each day. Analyzing the latest market trends, financial data, and expert opinions to recommend the best stocks for investment. If your just a beginner or an investor, stay informed and make smarter investment decisions with Buddyfin AI. `,
